...
object UAAUtils {
  ...
  def addClient(
    ...
    dacDetails: PredixDACDetails,
    adminToken: String,
    logger: LoggerUtils): Map[String, String] = {
      logger.showAndAppendToLogFile("info", "\n * Executing addClient...")
      val createClientBodyAsJson = _generateCreateClientBodyAsJson(clientId, clientSecret, tsDetails, assetDetails, dacDetails)
      val h = Map(
        "content-type"  -> "application/json",
        "Authorization" -> adminToken
      )
  ...
  private def _generateCreateClientBodyAsJson(
    ...
    tsDetails: PredixTimeSeriesDetails,
    assetDetails: PredixAssetDetails,
    dacDetails: PredixDACDetails): String = {
      ...
      val scopes = _generateClientScopeList(tsDetails, assetDetails, dacDetails)
      val authorities = _generateClientAuthoritiesList(tsDetails, assetDetails, dacDetails)
