...
val INSTANCE_PREPENDER = "your-name-predix-dac"
...
// Name of the PostgreSQL plan (eg: Dedicated-XX.1*) - default already set
...
/***********  Predix DAC Configurations ***********/

// The name of the Decysion App Composer service you are binding to - default already set
