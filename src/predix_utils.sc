...
object PredixUtils {
  ...
  // createDACService
  def createDACService(
    dacServiceName: String,
    dacServicePlan: String,
    dacInstanceName: String,
    trustedIssuerIds: String): Option[String] = {
      val createDacCommand = s"""cf cs $dacServiceName $dacServicePlan $dacInstanceName -c {"trustedIssuerIds":["$trustedIssuerIds"]} """
      createService(dacInstanceName, createDacCommand)
  } // End of createDACService
  ...
  // getDACConfigfromVCAP
  def getDACConfigfromVCAP(jsonContent: upickle.Js.Value) = (
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("label").toString.replace("\"", ""),
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("name").toString.replace("\"", ""),
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("plan").toString.replace("\"", ""),
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("credentials")("uri").toString.replace("\"", ""),
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("credentials")("zone")("http-header-value").toString.replace("\"", ""),
    "predix-app-composer.zones."+jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("credentials")("zone")("http-header-value").toString.replace("\"", "")+".user",
    jsonContent("VCAP_SERVICES")(DAC_SERVICE_NAME)(0)("credentials")("zone")("oauth-scope").toString.replace("\"", "")
  ) // End of getDACConfigfromVCAP
